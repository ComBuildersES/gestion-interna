...
* 🎯 **Objetivo**: **Gestión de herramientas internas**: Crear o mantener herramientas de soporte a la comunidad (e.g. scripts, automatización de puntos, gestión en GitHub, formularios).
* ✅ **Requisitos**: 
